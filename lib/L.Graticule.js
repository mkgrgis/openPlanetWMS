...
L.Graticule = L.GeoJSON.extend({
    ...
    _getFrame: function() {
        return { "type": "Polygon",
          "coordinates": [
              this._getMeridian(-360).concat(this._getMeridian(360).reverse())
          ]
        };
    },
    ...
    _getGraticule: function () {
        ...
        // Meridians
        for (var lng = -360; lng <= 360; lng = lng + interval) {
